...
public class ContratoController {
    ...
    public ContratoController(ContratoRepo contratoRepo) {
        this.contratoRepo = contratoRepo;
    }

    @PostMapping("/crear")
    public ResponseEntity<List<Contrato>> crearActividad(@RequestBody List<Contrato> a) {
        //TODO: process POST request
        
        return ResponseEntity.status(HttpStatus.CREATED).body(contratoRepo.saveAll(a));
    };
