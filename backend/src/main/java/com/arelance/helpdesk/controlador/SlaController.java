...
public class SlaController {
    ...
    public SlaController(SlaRepo slaRepo) {
        this.slaRepo = slaRepo;
    }

    @PostMapping("/crear")
    public ResponseEntity<List<SLA>> crearActividad(@RequestBody List<SLA> a) {
        //TODO: process POST request
        
        return ResponseEntity.status(HttpStatus.CREATED).body(slaRepo.saveAll(a));
    };
